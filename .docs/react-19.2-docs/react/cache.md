...
#### When should I use `cache`, [`memo`](/reference/react/memo), or [`useMemo`](/reference/react/useMemo)?
...
[PreviousaddTransitionType](/reference/react/addTransitionType)[NextcacheSignal](/reference/react/cacheSignal)
