...
function runMigrations() {
  ...
  db.exec(`
    ...
    -- Performance Optimization: Partial indexes to avoid full table scans + temporary B-tree
    -- when filtering paginated history by image/video type (videoGenerationParams NULL check)
