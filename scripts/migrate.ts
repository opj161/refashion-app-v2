...
function runMigrations() {
  ...
  // This prevents SqliteError: no such column on older databases during upgrades
  ...
  db.exec(`
    ...
    -- and significantly improve paginated query performance for image/video filtering.
