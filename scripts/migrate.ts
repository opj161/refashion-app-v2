...
function runMigrations() {
  ...
  db.exec(`
    ...
    -- Performance Optimization: Partial index to prevent full row evaluation for video-filtered pagination
    ...
    -- Performance Optimization: Partial index to prevent full row evaluation for image-filtered pagination
