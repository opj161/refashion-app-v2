...
function runMigrations() {
  ...
  db.exec(`
    ...
    -- Performance Optimization: Partial indexes to prevent full row evaluation and
    -- JSON deserialization during paginated queries filtered by video or image types.
