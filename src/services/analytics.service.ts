...
export function getDashboardKpis(): Omit<KpiData, 'totalStorageUsed'> {
  ...
  // ⚡ Bolt: Combined 3 separate COUNT queries into a single scan using conditional aggregation.
  // Using COALESCE for the failed count because SUM returns NULL on an empty dataset.
