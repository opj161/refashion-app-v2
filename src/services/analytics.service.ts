...
export function getDashboardKpis(): Omit<KpiData, 'totalStorageUsed'> {
  ...
  // Performance Optimization: Combine multiple COUNT/SUM aggregations into a single query
  // using conditional aggregation. This avoids multiple full table or index scans for the same time range.
