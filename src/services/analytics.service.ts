...
export function getDashboardKpis(): Omit<KpiData, "totalStorageUsed"> {
  ...
  // ⚡ Bolt: Performance Optimization - Combined three COUNT queries into a single query
  // using conditional aggregation. This prevents scanning the filtered rows multiple times.
