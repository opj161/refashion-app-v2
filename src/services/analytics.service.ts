...
export function getDashboardKpis(): Omit<KpiData, 'totalStorageUsed'> {
  ...
  // Combined 3 separate aggregation queries into a single query to reduce database round-trips
  // and prevent multiple B-Tree temp sorts/scans on the history table over the same timestamp range.
