...
export function getDashboardKpis(): Omit<KpiData, 'totalStorageUsed'> {
  ...
  // Performance Optimization: Combine three COUNT aggregations into a single query
  // using conditional aggregation. This avoids scanning the 'history' table three times.
