...
export function getDashboardKpis(): Omit<KpiData, 'totalStorageUsed'> {
  ...
  // ⚡ Bolt: Combined 3 queries into 1 using conditional aggregation.
  // Reduces database roundtrips from 3 to 1 for Dashboard KPIs.
  // Using COALESCE for SUM to handle the SQLite behavior where SUM() on empty sets returns NULL.
