...
describe('Database Migration System', () => {
  ...
  test('should create a new database with the latest schema version', () => {
    ...
    const hasImagePaginationIndex = historyIndexes.some(idx => idx.name === 'idx_history_username_timestamp_image');
    expect(hasImagePaginationIndex).toBe(true);

    const hasVideoPaginationIndex = historyIndexes.some(idx => idx.name === 'idx_history_username_timestamp_video');
