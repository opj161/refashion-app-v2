...
function AlertDialogContent({ className, ref, ...props }: React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content> & { ref?: React.Ref<React.ComponentRef<typeof AlertDialogPrimitive.Content>> }) {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
